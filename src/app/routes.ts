...
export const router = createBrowserRouter([
  ...
  // Protected routes (app layout)
  {
    ...
    children: [
      ...
      { path: '/metas/anuais', Component: MetasAnuaisPage },
      { path: '/metas/anuais/criar', Component: MetaAnualCreatePage },
      { path: '/metas/anuais/:id', Component: MetaDetailPage },
      { path: '/metas/anuais/:id/editar', Component: MetaEditPage },

      { path: '/metas/mensais', Component: MetasMensaisPage },
      { path: '/metas/mensais/criar', Component: MetaMensalCreatePage },
      { path: '/metas/mensais/:id', Component: MetaDetailPage },
      { path: '/metas/mensais/:id/editar', Component: MetaEditPage },

      { path: '/metas/semanais', Component: MetasSemanaisPage },
      { path: '/metas/semanais/criar', Component: MetaSemanalCreatePage },
      { path: '/metas/semanais/:id', Component: MetaDetailPage },
      { path: '/metas/semanais/:id/editar', Component: MetaEditPage },

      { path: '/metas/diarias', Component: MetasDiariasPage },
      { path: '/metas/diarias/criar', Component: MetaDiariaCreatePage },
      { path: '/metas/diarias/:id', Component: MetaDetailPage },
      { path: '/metas/diarias/:id/editar', Component: MetaEditPage },
