...
import { anualMetaSchema, type AnualMetaFormSchema } from './schemas/anualMetaSchema';
...
const NIVEL_LABEL = 'Meta Anual';
const NIVEL: MetaNivel = 'anual';
...
// ==========================================
export default function MetaAnualCreatePage() {
  ...
  const form = useForm<AnualMetaFormSchema>({
    resolver: zodResolver(anualMetaSchema),
    defaultValues: {
      titulo: '',
      area_id: null,
      descricao: null,
  ...
  const onSubmit = async (values: AnualMetaFormSchema) => {
    if (!user) return;
      ...
      <div className="max-w-6xl mx-auto p-4 lg:p-8">
        ...
        >
          ...
          <p className="text-slate-600">
            Defina o que você precisa conquistar este ano em 3 passos
          </p>
        </motion.div>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)}>
                    ...
                    {currentStep === 1 && (
                      ...
                      >
                            ...
                            <FormItem>
                              ...
                              <FormControl>
                                <div className="relative">
                                  <Input
                                    placeholder="Ex: Lançar produto no mercado"
                                    {...field}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-slate-700">Prazo (1 ano) *</FormLabel>
                              <FormControl>
                                <div className="relative">
                                  <Input
                                    type="date"
                                    {...field}
                                    className="border-2 border-slate-200 focus:border-indigo-500 transition-all"
                                  />
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem className="m-0">
                                  <FormControl>
                                    <Input
                                      placeholder="Qual é a ÚNICA coisa que posso fazer este ano..."
                                      {...field}
                                      value={field.value || ''}
                            ...
                            {prioridadeOptions.map((option) => {
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <div>
                                    <p className={`font-semibold ${isSelected ? 'text-indigo-700' : 'text-slate-800'}`}>
                                      {option.label}
                                    </p>
                ...
                <div className="px-6 lg:px-8 py-4 bg-slate-50 border-t border-slate-100 flex justify-between">
                  <button
                    type="button"
                    onClick={currentStep === 1 ? () => navigate('/metas/anuais') : prevStep}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-indigo-700 text-sm">
                      Metas anuais devem ser ambiciosas mas alcançáveis. Foque no que realmente importa para avançar suas grandes metas.
                    </p>
                  </div>
                </div>
              </div>
