...
const NIVEL_LABEL = 'Meta Semanal';
const NIVEL: MetaNivel = 'semanal';
...
export default function MetaSemanalCreatePage() {
  ...
  const onSubmit = async (values: SemanalMetaFormSchema) => {
    ...
    // CORREÇÃO: Garantir que o prazo nunca seja string vazia
    const prazoFinal = values.prazo && values.prazo.trim() !== '' 
      ? values.prazo 
      ...
      <div className="max-w-6xl mx-auto p-4 lg:p-8">
        ...
        >
          ...
          <p className="text-slate-600">
            Defina o que você precisa conquistar esta semana em 3 passos
          </p>
        </motion.div>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)}>
                    ...
                    {currentStep === 1 && (
                      ...
                      >
                            ...
                            <FormItem>
                              ...
                              <FormControl>
                                <Textarea
                                  ...
                                  className="resize-none border-2 border-slate-200 focus:border-amber-500 transition-all"
                                  rows={3}
                                  {...field}
                                  value={field.value || ''}
                                />
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-slate-700">Prazo (1 semana) *</FormLabel>
                              <FormControl>
                                <div className="relative">
                                  <Input
                                    type="date"
                                    {...field}
                                    className="border-2 border-slate-200 focus:border-amber-500 transition-all"
                                  />
                        ...
                        <div className="flex flex-wrap gap-2">
                          {quickDateOptions.map((opt) => (
                            <button
                              ...
                              className="px-3 py-1.5 bg-slate-100 hover:bg-amber-100 text-slate-600 hover:text-amber-700 rounded-lg text-sm font-medium transition-colors"
                            >
                              {opt.label}
                            </button>
                          ))}
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem className="m-0">
                                  <FormControl>
                                    <Input
                                      placeholder="Qual é a ÚNICA coisa que posso fazer esta semana..."
                                      {...field}
                                      value={field.value || ''}
                ...
                <div className="px-6 lg:px-8 py-4 bg-slate-50 border-t border-slate-100 flex justify-between">
                  <button
                    type="button"
                    onClick={currentStep === 1 ? () => navigate('/metas/semanais') : prevStep}
                  ...
                  {currentStep < 3 && (
                    <button
                      type="button"
                      onClick={nextStep}
                      className="flex items-center gap-2 px-6 py-2 bg-amber-600 text-white rounded-lg font-medium hover:bg-amber-700 transition-colors"
                    >
                      Continuar
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-amber-700 text-sm">
                      Metas semanais são curtas e acionáveis. Foque em entregas concretas que avançem suas metas mensais.
                    </p>
                  </div>
                </div>
              </div>
