...
import type { Meta, Prioridade } from '../types';

const nivelLabel = 'Grande Meta';
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-6">
        <Button variant="ghost" size="icon" onClick={() => navigate('/metas/grandes')}>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Prazo (3 anos) *</FormLabel>
                      <FormControl>
          ...
          {/* Campos SMART */}
          <SmartFields nivel="grande" />

          <div className="flex justify-end gap-3">
            <Button
              type="button"
              variant="outline"
              onClick={() => navigate('/metas/grandes')}
            >
              Cancelar
            </Button>
            <Button type="submit">
